...
# ensuring that any user input is validated and re-obtained if necessary.

#(10 points): As a developer, I want to store all of the gesture options/choices in a List (AS STRINGS). 
# I want to find a way to utilize the list of gestures within my code (display gesture options,
